...
{{/*
Create the database URL for Logto
*/}}
{{- define "logto.databaseUrl" -}}
postgres://{{ .Values.postgresql.auth.username }}:{{ .Values.postgresql.auth.password }}@{{ include "logto.fullname" . }}-postgresql:{{ .Values.postgresql.service.port }}/{{ .Values.postgresql.auth.database }}
{{- end }}